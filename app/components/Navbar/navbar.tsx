    ...
    <header className={`navbar-container ${dark ? 'bg-blue-500 text-white' : 'bg-white text-black'}`}>
      <nav className="flex items-center justify-between px-4 py-2">
        ...
        <ul className="flex space-x-4">
          ...
          <li><Link href="/about" className={`hover:text-[#034cbc] ${dark ? 'text-white' : 'text-black'} cursor-pointer`}>About</Link></li>
          <li><Link href="/browse" className={`hover:text-[#034cbc] ${dark ? 'text-white' : 'text-black'} cursor-pointer`}>Browse</Link></li>
          <li><Link href="/author" className={`hover:text-[#034cbc] ${dark ? 'text-white' : 'text-black'} cursor-pointer`}>Become an Author</Link></li>
        </ul>
        <ul className="flex space-x-4">
